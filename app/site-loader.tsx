      ...
      <div className="site-loader__content">
        <div className="site-loader__mark" aria-hidden="true">
          <svg
            ...
            strokeLinecap="round"
          >
            <rect x="9" y="4" width="24" height="32" rx="3" />
            <circle cx="17" cy="13" r="3" />
            <path d="M14 21h14M14 26h14M14 31h8" />
          </svg>
        </div>
        <span className="site-loader__brand">CV BUILDER</span>
        <span className="site-loader__track" aria-hidden="true">
          <span />
        </span>
        <span className="site-loader__label">
          <span lang="es">Cargando</span> / <span lang="en">Loading</span>
        </span>
      </div>
    </div>
  );
